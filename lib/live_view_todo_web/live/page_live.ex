defmodule LiveViewTodoWeb.PageLive do
  ...
  alias LiveViewTodo.Item
      ...
      #Function create item todo list
      @impl true
    ...
    #Function update item todo list
      @impl true
    ...
    #Function checked item todo list
      @impl true
    ...
    #Function clear completed todo list
      @impl true
    ...
    #Function filter items todo list items
      @impl true
